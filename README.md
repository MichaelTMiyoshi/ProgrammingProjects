...
| Wordle | Implement the game.  Use the file with the [legal words](https://github.com/MichaelTMiyoshi/ProgrammingProjects/blob/main/valid-wordle-words.txt).  (If you do some investigation, you will note that not all the legal words are words that can be the target.  See if you can implement this notion of two lists of words into your program.) | files, lists | X | X | X | 2 |
